...
import jam from './jqueryAjaxMiddleware';
import logM from './logMiddleware';
...
const rootReducer = combineReducers(Object.assign({}, reducers, {routing: routerReducer}));

export default function configStore(initState) {
    return customCreateStore(rootReducer, initState);
}
